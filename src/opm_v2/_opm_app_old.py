...
def main() -> None:
    ...
    def custom_execute_mda(output: Path | str | object | None) -> None:
        ...
        #--------------------------------------------------------------------#
        print(mmc.getProperty("AO-mode", "Label"))
        ...
        print(mmc.getProperty("O2O3focus-mode", "Label"))
        ...
        max_z_pos = float(sequence_dict["z_plan"]["top"])
        min_z_pos = float(sequence_dict["z_plan"]["bottom"])
        ...
        if mda_stage_positions is not None:
            if len(mda_stage_positions) == 1:
                ...
                if grid_plan is not None:
                    ...
                    print(max_x_pos, min_x_pos, max_y_pos, min_y_pos)
                    print(num_x_pos, num_y_pos, num_z_pos)
                    # for x_pos in range(num_x_pos):
                    #     for y_pos in range(num_y_pos):
